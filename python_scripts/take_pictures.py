...
parser.add_argument(
    "--imgdir",
    help="Folder to save images in (will be created if it doesn't exist already",
    default="Pics",
)
parser.add_argument(
    "--resolution", help="Desired camera resolution in WxH.", default="1280x720"
)
...
print(
    "Press s to take a picture. Pictures will automatically be saved in the %s folder."
    % dirname
)
